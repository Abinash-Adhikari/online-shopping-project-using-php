            ...
            <div class="navbar">
                ...
                <div class="navbar-buttons">
                    ...
                    <a href="manageProducts.php">
                        ...
                        <button class="btn btn-nav btn-manageProducts active"> <i class="fas fa-cogs"></i> Manage Products</button>
                    </div>
                    </a>
            ...
            <div class="header-top">
                <div class="all-top">
                    ...
                    <div class="current-page">
                        <h2 class="show"> Manage Products </h2>
                    </div>
                    ...
                    <div class="display-flex">
                        ...
                        <div class="categories-detail bg">
                            <div class="form form-addProduct">
                                ...
                                <div class="form-part">
                                    <form action="uploadNewProduct.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="display-flex">
                                                ...
                                                <div class="photos">
                                                    ...
                                                    <!-- <div class="left-photo inp-same">
                                                        ...
                                                        <input type="file" id="left-photo" name="left-photo" >
                                                    </div>
                                                    <div class="right-photo inp-same">
                                                        <label for="right-photo"> Right Photo </label>
                                                        <input type="file" id="right-photo" name="right-photo" >
                                                    </div> -->
                                                    <div class="back-photo inp-same">
                                                        <label for="back-photo"> Others Photo </label>
                                                        <input type="file" id="back-photo" name="back-photo" >
                                                    </div>
                                ...
                                <div class="table">
                                    ...
                                    <table class="table-detailProduct">
                                       ...
                                       <tbody class="dp-tbody">
                                           <?php
                                                $sql_product = "SELECT * FROM $table WHERE admin_id = '$adminId' && producttype='new';";
